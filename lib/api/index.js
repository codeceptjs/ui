...
// const runNew = require('./new-test'); // Temporarily disabled for CodeceptJS 3.x compatibility
...
// router.post('/run-new', jsonParser, runNew); // Temporarily disabled for CodeceptJS 3.x compatibility
