...
module.exports = async (req, res) => {
  ...
  debug(`Running feature/scenario by grep "${scenario}"`);

  const runner = codeceptjsFactory.createRunner(TestProjectDir, getConfig('Puppeteer'), { steps: true, grep: scenario });
